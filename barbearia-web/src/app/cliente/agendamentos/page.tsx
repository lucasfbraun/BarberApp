    ...
    <div className="rounded-3xl border border-slate-200 bg-slate-50 p-5">
      ...
      <div className="mt-3 flex gap-2">
        <Link href={`/s/${a.barbershop.slug}/agendar`}
          className="rounded-xl border border-slate-200 bg-slate-50 px-3 py-1.5 text-xs text-slate-600 transition hover:text-slate-900">
          Agendar de novo
        </Link>
        {cancellable && (
          <button
          ...
          <>
            <section>
              ...
              <div className="space-y-3">
                ...
                {upcoming.length === 0 && (
                  <p className="rounded-3xl border border-slate-200 bg-slate-50 p-5 text-sm text-slate-400">
